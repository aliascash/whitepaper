...
\begin{figure}[ht]
	...
	\caption{Your wallet will show your \textbf{XSPEC} balance and your 
		\textbf{SPECTRE} balance.}
\end{figure}
...
\begin{tabular}{@{}ll@{}}
\hline
\textbf{Recipient privacy} & Stealth  addresses  are  used  to  protect  the  recipient’s  privacy.   (SPECTRE only) \\ 
\midrule
\textbf{Sender privacy} & Ring Signatures are used to protect the sender’s privacy.  (SPECTRE only) \\ 
\midrule
\textbf{IP address privacy} & All Spectrecoin nodes run as TOR hidden services to protect users IP address. \\
\midrule
\textbf{Un-traceability} & for each incoming transaction all possible senders are equiprobable. \\
\midrule
\textbf{Un-linkability} & for  two  outgoing  transactions  it  is  impossible  to  prove  the  same  receiver.(SPECTRE only) \\
\hline
\end{tabular}%
}
\end{table}
