...
\begin{figure}[ht]
	...
	\centering
	\includegraphics[width=\textwidth]{ALIAS-StakeExample01.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{ALIAS-StakeExample02.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{ALIAS-ConsolidationExample01.png}
	\caption{In this example you can see $10 * 30$ ALIAS (private) being consolidated 
	into $1 * 300$ ALIAS (private)}
\end{figure}
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{ALIAS-ConsolidationExample02.png}
